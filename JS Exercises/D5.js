...
const alphabetItalian = "abcdefghijklmnopqrstuvwxyz";
const positionsArray = charactersArray.map((char) => {
  const lowerCaseChar = char.toLowerCase();
  const position = aplhabetItalian.indexOf(lowercaseChar);
  return position + 1;
});
